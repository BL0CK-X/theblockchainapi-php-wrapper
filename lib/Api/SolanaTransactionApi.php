...
/**
 * SolanaTransactionApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class SolanaTransactionApi
{
    ...
    /**
     * Operation solanaGetTransaction
     *
     * Get the details of a transaction made on Solana
     *
     * @param  string $network The network ID (devnet, mainnet-beta) (required)
     * @param  string $tx_signature The transaction signature of the transaction (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Transaction
     */
    public function solanaGetTransaction($network, $tx_signature)
    {
        list($response) = $this->solanaGetTransactionWithHttpInfo($network, $tx_signature);
        return $response;
    }

    /**
     * Operation solanaGetTransactionWithHttpInfo
     *
     * Get the details of a transaction made on Solana
     *
     * @param  string $network The network ID (devnet, mainnet-beta) (required)
     ...
     */
    public function solanaGetTransactionWithHttpInfo($network, $tx_signature)
    {
        $request = $this->solanaGetTransactionRequest($network, $tx_signature);
    ...
    /**
     * Operation solanaGetTransactionAsync
     *
     * Get the details of a transaction made on Solana
     *
     * @param  string $network The network ID (devnet, mainnet-beta) (required)
     ...
     */
    public function solanaGetTransactionAsync($network, $tx_signature)
    {
        return $this->solanaGetTransactionAsyncWithHttpInfo($network, $tx_signature)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation solanaGetTransactionAsyncWithHttpInfo
     *
     * Get the details of a transaction made on Solana
     *
     * @param  string $network The network ID (devnet, mainnet-beta) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function solanaGetTransactionAsyncWithHttpInfo($network, $tx_signature)
    {
        $returnType = '\OpenAPI\Client\Model\Transaction';
        $request = $this->solanaGetTransactionRequest($network, $tx_signature);
    ...
    /**
     * Create request for operation 'solanaGetTransaction'
     *
     * @param  string $network The network ID (devnet, mainnet-beta) (required)
     * @param  string $tx_signature The transaction signature of the transaction (required)
     *
     ...
     */
    public function solanaGetTransactionRequest($network, $tx_signature)
    {
        // verify the required parameter 'network' is set
        if ($network === null || (is_array($network) && count($network) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $network when calling solanaGetTransaction'
            );
        }
        // verify the required parameter 'tx_signature' is set
        if ($tx_signature === null || (is_array($tx_signature) && count($tx_signature) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tx_signature when calling solanaGetTransaction'
            );
        }

        $resourcePath = '/solana/transaction/{network}/{tx_signature}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($tx_signature !== null) {
            $resourcePath = str_replace(
                '{' . 'tx_signature' . '}',
                ObjectSerializer::toPathValue($tx_signature),
                $resourcePath
            );
        }
