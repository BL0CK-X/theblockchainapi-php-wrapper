...
class SolanaNFTApi
{
    ...
    /**
     * Operation solanaGetNFTOwnerAdvanced
     *
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\NFTOwnerAdvancedResponse
     */
    public function solanaGetNFTOwnerAdvanced($network, $mint_address)
    {
        list($response) = $this->solanaGetNFTOwnerAdvancedWithHttpInfo($network, $mint_address);
        return $response;
    }

    /**
     * Operation solanaGetNFTOwnerAdvancedWithHttpInfo
     *
     * Get owner of an NFT (advanced)
     *
     * @param  string $network The network ID (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\NFTOwnerAdvancedResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function solanaGetNFTOwnerAdvancedWithHttpInfo($network, $mint_address)
    {
        $request = $this->solanaGetNFTOwnerAdvancedRequest($network, $mint_address);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\NFTOwnerAdvancedResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\NFTOwnerAdvancedResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\NFTOwnerAdvancedResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\NFTOwnerAdvancedResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation solanaGetNFTOwnerAdvancedAsync
     *
     * Get owner of an NFT (advanced)
     *
     * @param  string $network The network ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function solanaGetNFTOwnerAdvancedAsync($network, $mint_address)
    {
        return $this->solanaGetNFTOwnerAdvancedAsyncWithHttpInfo($network, $mint_address)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation solanaGetNFTOwnerAdvancedAsyncWithHttpInfo
     *
     * Get owner of an NFT (advanced)
     *
     * @param  string $network The network ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function solanaGetNFTOwnerAdvancedAsyncWithHttpInfo($network, $mint_address)
    {
        $returnType = '\OpenAPI\Client\Model\NFTOwnerAdvancedResponse';
        $request = $this->solanaGetNFTOwnerAdvancedRequest($network, $mint_address);
    ...
    /**
     * Create request for operation 'solanaGetNFTOwnerAdvanced'
     *
     * @param  string $network The network ID (required)
     * @param  string $mint_address The mint address of the NFT (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function solanaGetNFTOwnerAdvancedRequest($network, $mint_address)
    {
        // verify the required parameter 'network' is set
        if ($network === null || (is_array($network) && count($network) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $network when calling solanaGetNFTOwnerAdvanced'
            );
        }
        // verify the required parameter 'mint_address' is set
        if ($mint_address === null || (is_array($mint_address) && count($mint_address) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $mint_address when calling solanaGetNFTOwnerAdvanced'
            );
        }

        $resourcePath = '/solana/nft/{network}/{mint_address}/owner_advanced';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation solanaSearchNFTs
     *
     * Search NFTs on Solana
     *
     * @param  \OpenAPI\Client\Model\NFTSearchRequest $nft_search_request nft_search_request (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->solanaSearchNFTsWithHttpInfo($nft_search_request);
        return $response;
    }

    /**
     * Operation solanaSearchNFTsWithHttpInfo
     *
     * Search NFTs on Solana
     *
     * @param  \OpenAPI\Client\Model\NFTSearchRequest $nft_search_request (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    /**
     * Operation solanaSearchNFTsAsync
     *
     * Search NFTs on Solana
     *
     * @param  \OpenAPI\Client\Model\NFTSearchRequest $nft_search_request (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function solanaSearchNFTsAsync($nft_search_request = null)
    {
        return $this->solanaSearchNFTsAsyncWithHttpInfo($nft_search_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation solanaSearchNFTsAsyncWithHttpInfo
     *
     * Search NFTs on Solana
     *
     * @param  \OpenAPI\Client\Model\NFTSearchRequest $nft_search_request (optional)
    ...
    /**
     * Create request for operation 'solanaSearchNFTs'
     *
     * @param  \OpenAPI\Client\Model\NFTSearchRequest $nft_search_request (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function solanaSearchNFTsRequest($nft_search_request = null)
    {

        $resourcePath = '/solana/nft/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($nft_search_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($nft_search_request));
            } else {
                $httpBody = $nft_search_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
