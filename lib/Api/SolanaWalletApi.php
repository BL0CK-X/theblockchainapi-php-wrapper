...
class SolanaWalletApi
{
    ...
    /**
     * Operation solanaGetWalletTransactions
     *
     * Get address&#39;s associated transaction signatures
     *
     * @param  string $network The network ID (devnet, mainnet-beta) (required)
     * @param  string $public_key The public key of the account whose list of signatures you want to get (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string[]
     */
    public function solanaGetWalletTransactions($network, $public_key)
    {
        list($response) = $this->solanaGetWalletTransactionsWithHttpInfo($network, $public_key);
        return $response;
    }

    /**
     * Operation solanaGetWalletTransactionsWithHttpInfo
     *
     * Get address&#39;s associated transaction signatures
     *
     * @param  string $network The network ID (devnet, mainnet-beta) (required)
     ...
     */
    public function solanaGetWalletTransactionsWithHttpInfo($network, $public_key)
    {
        $request = $this->solanaGetWalletTransactionsRequest($network, $public_key);
    ...
    /**
     * Operation solanaGetWalletTransactionsAsync
     *
     * Get address&#39;s associated transaction signatures
     *
     * @param  string $network The network ID (devnet, mainnet-beta) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function solanaGetWalletTransactionsAsync($network, $public_key)
    {
        return $this->solanaGetWalletTransactionsAsyncWithHttpInfo($network, $public_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation solanaGetWalletTransactionsAsyncWithHttpInfo
     *
     * Get address&#39;s associated transaction signatures
     *
     * @param  string $network The network ID (devnet, mainnet-beta) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function solanaGetWalletTransactionsAsyncWithHttpInfo($network, $public_key)
    {
        $returnType = 'string[]';
        $request = $this->solanaGetWalletTransactionsRequest($network, $public_key);
    ...
    /**
     * Create request for operation 'solanaGetWalletTransactions'
     *
     * @param  string $network The network ID (devnet, mainnet-beta) (required)
     * @param  string $public_key The public key of the account whose list of signatures you want to get (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function solanaGetWalletTransactionsRequest($network, $public_key)
    {
        // verify the required parameter 'network' is set
        if ($network === null || (is_array($network) && count($network) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $network when calling solanaGetWalletTransactions'
            );
        }
        // verify the required parameter 'public_key' is set
        if ($public_key === null || (is_array($public_key) && count($public_key) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $public_key when calling solanaGetWalletTransactions'
            );
        }

        $resourcePath = '/solana/wallet/{network}/{public_key}/transactions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\DoubleTransferResponse
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\DoubleTransferResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function solanaTransferWithHttpInfo($transfer_request = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\DoubleTransferResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\DoubleTransferResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\DoubleTransferResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\DoubleTransferResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
