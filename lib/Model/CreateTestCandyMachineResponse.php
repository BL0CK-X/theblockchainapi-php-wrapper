...
/**
 * CreateTestCandyMachineResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateTestCandyMachineResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateTestCandyMachineResponse';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['candy_machine_id'] === null) {
            $invalidProperties[] = "'candy_machine_id' can't be null";
        }
     ...
     *
     * @param string $candy_machine_id The ID of the candy machine created
     *
     * @return self
     */
