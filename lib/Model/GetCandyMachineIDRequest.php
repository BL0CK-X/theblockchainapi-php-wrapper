...
/**
 * GetCandyMachineIDRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetCandyMachineIDRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetCandyMachineIDRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['mint_address'] === null) {
            $invalidProperties[] = "'mint_address' can't be null";
        }
     ...
     * Sets mint_address
     *
     * @param string $mint_address The address of the NFT. NOT the mint authority address
     *
     * @return self
     */
