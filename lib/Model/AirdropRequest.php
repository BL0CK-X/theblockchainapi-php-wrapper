...
/**
 * AirdropRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AirdropRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AirdropRequest';
     ...
     *
     * @param string $recipient_address The address to which to send the airdrop of 0.015 SOL
     *
     * @return self
     */
