...
/**
 * SolSeaListResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SolSeaListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SolSeaListResponse';
     ...
     *
     * @param string|null $transaction_signature The signature of the `list` transaction
     *
     * @return self
     */
