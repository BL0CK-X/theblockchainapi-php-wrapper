...
/**
 * CreateTestCandyMachineRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateTestCandyMachineRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateTestCandyMachineRequest';
    ...
    /**
     * Gets include_gatekeeper
     *
     * @return bool|null
     */
    public function getIncludeGatekeeper()
    {
        return $this->container['include_gatekeeper'];
    }

    /**
     * Sets include_gatekeeper
     *
     * @param bool|null $include_gatekeeper Whether or not to include a gatekeeper for testing purposes. Only applies to v2 candy machines.
     *
     * @return self
     */
    public function setIncludeGatekeeper($include_gatekeeper)
    {
        $this->container['include_gatekeeper'] = $include_gatekeeper;
