...
/**
 * GetAllNFTsResponseMintedNfts Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetAllNFTsResponseMintedNfts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetAllNFTsResponse_minted_nfts';
    ...
    protected static $openAPITypes = [
        'nft_metadata' => '\OpenAPI\Client\Model\NFT',
        'pub_key_hash' => 'string'
    ];
    ...
    {
        $this->container['nft_metadata'] = $data['nft_metadata'] ?? null;
        $this->container['pub_key_hash'] = $data['pub_key_hash'] ?? null;
    }
     ...
     * Sets nft_metadata
     *
     * @param \OpenAPI\Client\Model\NFT|null $nft_metadata nft_metadata
     *
     * @return self
     */
    ...
    {
        return $this->container['pub_key_hash'];
    }

    /**
     * Sets pub_key_hash
     *
     * @param string|null $pub_key_hash Use this to verify the NFT
     *
     * @return self
     */
    public function setPubKeyHash($pub_key_hash)
    {
        $this->container['pub_key_hash'] = $pub_key_hash;
