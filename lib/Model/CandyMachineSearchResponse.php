...
/**
 * CandyMachineSearchResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CandyMachineSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CandyMachineSearchResponse';
     ...
     * Sets config_address
     *
     * @param string $config_address The config address of the candy machine
     *
     * @return self
     */
