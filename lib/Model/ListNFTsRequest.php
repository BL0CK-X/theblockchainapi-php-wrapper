...
/**
 * ListNFTsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ListNFTsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListNFTsRequest';
     ...
     * Sets public_key
     *
     * @param string $public_key The public key of the account whose list of owned NFTs you want to get
     *
     * @return self
     */
