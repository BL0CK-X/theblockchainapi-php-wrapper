...
/**
 * AccountIsNFT Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccountIsNFT implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountIsNFT';
    ...
    {
        $this->container['is_nft'] = $data['is_nft'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_nft'] === null) {
            $invalidProperties[] = "'is_nft' can't be null";
        }
    ...
    {
        return $this->container['is_nft'];
    }

    /**
     * Sets is_nft
     *
     * @param bool $is_nft is_nft
     *
     * @return self
     */
    public function setIsNft($is_nft)
    {
        $this->container['is_nft'] = $is_nft;
