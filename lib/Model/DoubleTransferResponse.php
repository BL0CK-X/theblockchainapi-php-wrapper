...
/**
 * DoubleTransferResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DoubleTransferResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DoubleTransferResponse';
     ...
     *
     * @param string|null $transaction_signature The signature of the transaction
     *
     * @return self
     */
     ...
     * Sets confirmed
     *
     * @param bool|null $confirmed Whether or not the transaction was confirmed or simply submitted for processing. The status depends on your input for `wait_for_confirmation`. This only is returned when you are submitting a transaction, not when retrieving signatures for a public key, for example.
     *
     * @return self
     */
