...
/**
 * AccountIsCandyMachine Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccountIsCandyMachine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountIsCandyMachine';
    ...
    protected static $attributeMap = [
        'is_candy_machine' => 'is_candy_machine',
    ...
    protected static $setters = [
        'is_candy_machine' => 'setIsCandyMachine',
    ...
    protected static $getters = [
        'is_candy_machine' => 'getIsCandyMachine',
    ...
    const CANDY_MACHINE_CONTRACT_VERSION_MAGIC_EDEN_V1 = 'magic-eden-v1';
    ...
    public function getCandyMachineContractVersionAllowableValues()
    {
        return [
            ...
            self::CANDY_MACHINE_CONTRACT_VERSION_MAGIC_EDEN_V1,
        ];
    }
    ...
    {
        $this->container['is_candy_machine'] = $data['is_candy_machine'] ?? null;
        $this->container['candy_machine_contract_version'] = $data['candy_machine_contract_version'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_candy_machine'] === null) {
            $invalidProperties[] = "'is_candy_machine' can't be null";
        }
    ...
    /**
     * Gets is_candy_machine
     *
     * @return bool
     */
    public function getIsCandyMachine()
    {
        return $this->container['is_candy_machine'];
    }

    /**
     * Sets is_candy_machine
     *
     * @param bool $is_candy_machine is_candy_machine
     *
     * @return self
     */
    public function setIsCandyMachine($is_candy_machine)
    {
        $this->container['is_candy_machine'] = $is_candy_machine;
     ...
     *
     * @param string|null $candy_machine_contract_version Whether or not this corresponds to candy machine v1, candy machine v2, or a Magic Eden candy machine.
     *
     * @return self
     */
