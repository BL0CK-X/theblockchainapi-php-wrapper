...
/**
 * GetAllNFTsResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetAllNFTsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetAllNFTsResponse';
     ...
     * Gets minted_nfts
     *
     * @return \OpenAPI\Client\Model\GetAllNFTsResponseMintedNfts[]|null
     */
    public function getMintedNfts()
    {
        return $this->container['minted_nfts'];
    }

    /**
     * Sets minted_nfts
     *
     * @param \OpenAPI\Client\Model\GetAllNFTsResponseMintedNfts[]|null $minted_nfts The minted NFTs. Only filled in for `v1` candy machines. Left empty for `v2`.
     *
     * @return self
     */
    public function setMintedNfts($minted_nfts)
    {
        $this->container['minted_nfts'] = $minted_nfts;
     ...
     * Gets unminted_nfts
     *
     * @return \OpenAPI\Client\Model\GetAllNFTsResponseUnmintedNfts[]|null
     */
    public function getUnmintedNfts()
    {
        return $this->container['unminted_nfts'];
    }

    /**
     * Sets unminted_nfts
     *
     * @param \OpenAPI\Client\Model\GetAllNFTsResponseUnmintedNfts[]|null $unminted_nfts The unminted NFTs. Only filled in for `v1` candy machines. Left empty for `v2`.
     *
     * @return self
     */
    public function setUnmintedNfts($unminted_nfts)
    {
        $this->container['unminted_nfts'] = $unminted_nfts;
    ...
    {
        return $this->container['all_nfts'];
    }

    /**
     * Sets all_nfts
     *
     * @param \OpenAPI\Client\Model\GetAllNFTsResponseUnmintedNfts[]|null $all_nfts The list of all NFTs. Filled in for both `v1` and `v2` NFTs.
     *
     * @return self
     */
