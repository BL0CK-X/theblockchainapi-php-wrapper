 ...
 *
 * @category Class
 * @description A group is a group of endpoints.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Group implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets section_name
     *
     * @param string|null $section_name The name of the section under which this group is listed. A section contains several groups.
     *
     * @return self
     */
     ...
     * Sets group_name
     *
     * @param string|null $group_name The name of the group
     *
     * @return self
     */
     ...
     *
     * @param string|null $group_description The description of the group
     *
     * @return self
     */
