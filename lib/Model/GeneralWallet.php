...
/**
 * GeneralWallet Class Doc Comment
 *
 * @category Class
 * @description The wallet authentication information used to sign and submit the transaction.  Click the &#x60;&gt;&#x60; arrow next to \&quot;wallet\&quot; on the left to see more details. See our Security section &lt;a href&#x3D;\&quot;#section/Security\&quot;&gt;here&lt;/a&gt;.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GeneralWallet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GeneralWallet';
    ...
    protected static $setters = [
        ...
        'hex_private_key' => 'setHexPrivateKey',
    ...
    protected static $getters = [
        ...
        'hex_private_key' => 'getHexPrivateKey',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['derivation_path'] = $data['derivation_path'] ?? null;
        $this->container['passphrase'] = $data['passphrase'] ?? '';
        $this->container['hex_private_key'] = $data['hex_private_key'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['hex_private_key'] === null) {
            $invalidProperties[] = "'hex_private_key' can't be null";
        }
    ...
    /**
     * Gets hex_private_key
     *
     * @return string
     */
    public function getHexPrivateKey()
    {
        return $this->container['hex_private_key'];
    }

    /**
     * Sets hex_private_key
     *
     * @param string $hex_private_key A hex private key is the typical private key used on Ethereum, for example. It looks like this: `0x200b9e5baa38b0dc7551645be11b394e9bf2b04532e4af8824bed2b3de2e0dc0`.  You can use `hex_private_key` for chains: `avalanche`, `binance_smart_chain`, `ethereum`.
     *
     * @return self
     */
    public function setHexPrivateKey($hex_private_key)
    {
        $this->container['hex_private_key'] = $hex_private_key;
