...
/**
 * GetCandyMachineIDResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetCandyMachineIDResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetCandyMachineIDResponse';
     ...
     *
     * @param string|null $candy_machine_id The ID of the candy machine that minted the NFT
     *
     * @return self
     */
