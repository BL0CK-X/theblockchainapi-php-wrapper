 ...
 */
class ATARequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ATARequest';
     ...
     * Sets token_address
     *
     * @param string $token_address The address of the token to get the ATA for. For an NFT, this is the same as `mint` (the mint address).
     *
     * @return self
     */
