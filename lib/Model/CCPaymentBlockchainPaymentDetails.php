...
/**
 * CCPaymentBlockchainPaymentDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class CCPaymentBlockchainPaymentDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CCPayment_blockchain_payment_details';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['payout_amount'] = $data['payout_amount'] ?? null;
     ...
     * Sets chain
     *
     * @param string|null $chain The chain on which the payment was made.
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getChainAllowableValues();
        if (!is_null($chain) && !in_array($chain, $allowedValues, true)) {
     ...
     * Sets fee_amount
     *
     * @param string|null $fee_amount The fee taken by the blockchain API. This is shown in integer form.
     *
     * @return self
     */
     ...
     * Sets payout_amount
     *
     * @param string|null $payout_amount The amount paid to the project's payout wallet (the recipient of the payment). This is shown in integer form.
     *
     * @return self
     */
     ...
     *
     * @param string|null $token_blockchain_identifier The blockchain identifier of the token used to pay. Currently, we only support payments in USDC.
     *
     * @return self
     */
     ...
     * Sets total_paid
     *
     * @param string|null $total_paid The total paid by the user when making the payment. This should match the amount set in the respective plan.
     *
     * @return self
     */
     ...
     *
     * @param string|null $transaction_signature The transaction signature which you can use to manually or automatically verify the transaction on the blockchain.
     *
     * @return self
     */
