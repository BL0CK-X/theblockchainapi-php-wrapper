 ...
 */
class NFTMintFee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NFTMintFee';
    ...
    protected static $openAPITypes = [
        'nft_mint_fee_estimate_lamports' => 'float',
        'description' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'nft_mint_fee_estimate_lamports' => null,
        'description' => null
    ];
    ...
    protected static $attributeMap = [
        'nft_mint_fee_estimate_lamports' => 'nft_mint_fee_estimate_lamports',
    ...
    protected static $setters = [
        'nft_mint_fee_estimate_lamports' => 'setNftMintFeeEstimateLamports',
    ...
    protected static $getters = [
        'nft_mint_fee_estimate_lamports' => 'getNftMintFeeEstimateLamports',
    ...
    {
        $this->container['nft_mint_fee_estimate_lamports'] = $data['nft_mint_fee_estimate_lamports'] ?? null;
    ...
    /**
     * Gets nft_mint_fee_estimate_lamports
     *
     * @return float|null
     */
    public function getNftMintFeeEstimateLamports()
    {
        return $this->container['nft_mint_fee_estimate_lamports'];
    }

    /**
     * Sets nft_mint_fee_estimate_lamports
     *
     * @param float|null $nft_mint_fee_estimate_lamports The estimate of the total fee for minting an NFT on Solana
     *
     * @return self
     */
    public function setNftMintFeeEstimateLamports($nft_mint_fee_estimate_lamports)
    {
        $this->container['nft_mint_fee_estimate_lamports'] = $nft_mint_fee_estimate_lamports;
     ...
     * Sets description
     *
     * @param string|null $description A description of the fee that explains how it was estimated
     *
     * @return self
     */
