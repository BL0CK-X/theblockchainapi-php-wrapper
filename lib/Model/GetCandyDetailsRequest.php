...
/**
 * GetCandyDetailsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetCandyDetailsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetCandyDetailsRequest';
     ...
     *
     * @param string $candy_machine_id The ID of the candy machine
     *
     * @return self
     */
