...
class UploadFileRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const UPLOAD_METHOD_IPFS = 'IPFS';
    const UPLOAD_METHOD_ARWEAVE = 'Arweave';
    const UPLOAD_METHOD_FILECOIN = 'Filecoin';
    ...
    {
        return [
            self::UPLOAD_METHOD_IPFS,
            self::UPLOAD_METHOD_ARWEAVE,
            self::UPLOAD_METHOD_FILECOIN,
        ];
    }
    ...
    {
        $this->container['upload_method'] = $data['upload_method'] ?? 'IPFS';
    }
     ...
     * Sets upload_method
     *
     * @param string|null $upload_method upload_method
     *
     * @return self
     */
