...
/**
 * NFTOwnerResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class NFTOwnerResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NFTOwnerResponse';
    ...
    {
        $this->container['nft_owner'] = $data['nft_owner'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['nft_owner'] === null) {
            $invalidProperties[] = "'nft_owner' can't be null";
        }
    ...
    {
        return $this->container['nft_owner'];
    }

    /**
     * Sets nft_owner
     *
     * @param string $nft_owner The public key address of the wallet that has ownership over the provided NFT
     *
     * @return self
     */
    public function setNftOwner($nft_owner)
    {
        $this->container['nft_owner'] = $nft_owner;
