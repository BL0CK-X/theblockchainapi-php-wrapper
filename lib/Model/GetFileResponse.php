...
/**
 * GetFileResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetFileResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetFileResponse';
     ...
     * Sets size
     *
     * @param string|null $size File size in kilobytes
     *
     * @return self
     */
     ...
     * Sets upload_time
     *
     * @param string|null $upload_time The time when the file was uploaded
     *
     * @return self
     */
