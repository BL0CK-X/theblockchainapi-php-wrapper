...
/**
 * GeneralBalanceResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GeneralBalanceResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GeneralBalanceResponse';
     ...
     *
     * @param float|null $integer_balance Not included if retreiving native token (e.g., SOL, ETH, BNB, etc.) balance
     *
     * @return self
     */
     ...
     * Sets decimals
     *
     * @param float|null $decimals Not included if retreiving native token (e.g., SOL, ETH, BNB, etc.) balance.
     *
     * @return self
     */
     ...
     * Sets unit
     *
     * @param string|null $unit Not included if retreiving a token / NFT balance
     *
     * @return self
     */
