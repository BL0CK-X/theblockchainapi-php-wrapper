...
/**
 * GetConfigInfoResponseCreators Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetConfigInfoResponseCreators implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetConfigInfoResponse_creators';
     ...
     * Sets address
     *
     * @param string|null $address Public key address of a creator
     *
     * @return self
     */
     ...
     * Sets share
     *
     * @param float|null $share The share of the royalty that the creator receives
     *
     * @return self
     */
