...
/**
 * SolSeaDelistResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SolSeaDelistResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SolSeaDelistResponse';
     ...
     *
     * @param string|null $transaction_signature The signature of the `delist` transaction
     *
     * @return self
     */
