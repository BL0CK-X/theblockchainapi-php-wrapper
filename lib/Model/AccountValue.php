...
/**
 * AccountValue Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccountValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Account_value';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['rent_epoch'] = $data['rent_epoch'] ?? null;
    }
     ...
     * Sets data
     *
     * @param object|null $data More info about the account. What are included depends on the type of account. See examples.
     *
     * @return self
     */
     ...
     * Sets executable
     *
     * @param bool|null $executable Whether or not this account is marked as executable
     *
     * @return self
     */
     ...
     * Sets owner
     *
     * @param string|null $owner The owner of the account
     *
     * @return self
     */
     ...
     * @return float|null
     */
    public function getRentEpoch()
    {
        return $this->container['rent_epoch'];
    }

    /**
     * Sets rent_epoch
     *
     * @param float|null $rent_epoch rent_epoch
     *
     * @return self
     */
    public function setRentEpoch($rent_epoch)
    {
        $this->container['rent_epoch'] = $rent_epoch;
