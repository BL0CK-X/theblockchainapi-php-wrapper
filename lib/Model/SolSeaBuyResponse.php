...
/**
 * SolSeaBuyResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SolSeaBuyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SolSeaBuyResponse';
     ...
     *
     * @param string|null $transaction_signature The signature of the `buy` transaction
     *
     * @return self
     */
